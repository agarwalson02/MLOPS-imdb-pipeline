...
def load_params(params_path:str)->dict:
    """Load the parmas from a yaml file"""
    try:
        ...
        raise MyException(f'Unexpected error: {e}', sys) from e
...
def apply_bow(train_data:pd.DataFrame,test_data:pd.DataFrame,max_features:int)->tuple:
    ...
    try:
        ...
        raise MyException(f'Error during Bag of Words transformation: {e}', sys) from e
...
def save_data(df:pd.DataFrame,file_path:str)->None:
    ...
    try:
        ...
        raise MyException(f'Unexpected error occurred while saving the data: {e}', sys) from e
...
def main():
    try:
        ...
        logging.info("Data feature engineering done")

    except Exception as e:
        raise MyException(f'Failed to complete the feature engineering process: {e}', sys) from e
